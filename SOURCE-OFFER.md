...
**TTS Sidecar 0.6.0** se distribuye bajo la licencia
...
- **Código fuente (tarball del tag):**
  <https://github.com/CristianRojas-SoftwareEngineer/TTS-Sidecar/archive/refs/tags/v0.6.0.tar.gz>
- **Release v0.6.0 (artefactos y notas):**
  <https://github.com/CristianRojas-SoftwareEngineer/TTS-Sidecar/releases/tag/v0.6.0>
